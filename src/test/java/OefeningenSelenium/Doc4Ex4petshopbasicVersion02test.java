 ...
 */
public class Doc4Ex4petshopbasicVersion02test {
    ...
    public void GoogleSearch() {
        ...
        *-----------------------------------------------------------------------------------*/
        ...
        Doing the tests
        ----------------------------------------------------------------------------------------*/
        //Change these values for going throug another test
        ...
        String[] linksInPage={ToAnimal, "Iguana"};
        //Title,Description,Price & Quantity check=>check text to what is expected
        String TheBeast= ToAnimalCategory+" "+ToAnimal;
        String TheDescription="Doubles as a watch dog";
        String ThePricie="$18.50";
        String TheQuantitie="9990";
